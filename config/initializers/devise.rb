...
Devise.setup do |config|
  ...
  # config.pepper = "67fe81fed103e6b25f548d85350793760685299c3e23852eb3e9cd001006af20d74c878cc67cc247da3c5d9bc34b6a531c057c1610a9bd1a6818c89aed46cf44"
  ...
  Warden::Manager.before_logout do |user, warden, options|
    Rails.logger.warn "⚠️ Warden logout is unsetting after #{warden.request.fullpath}"
    byebug
