module Droom
  ...
  protected
    ...
    def set_view
      @view = params[:view] if %w{listed tabled profile preferences my_profile title contact personal account_info statuses groups biography result}.include?(params[:view])
      #@view ||= 'profile'
    end
